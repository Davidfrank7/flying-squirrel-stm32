...
void VL_IIC_SCL(uint8_t Data)
{
	  if(Data==1)
		{
		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_SET);//PA11输出高	
		}else 
		{
		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_RESET);//PA11输出低	
		}
}
...
void VL_IIC_SDA(uint8_t Data)
{
	  if(Data==1)
		{
		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_SET);//PA12输出高	
		}else 
		{
		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_RESET);//PA12输出低	
		}
}
...
void VL53L0X_i2c_init(void)
{
	...
	GPIO_Initure.Pin=GPIO_PIN_6|GPIO_PIN_7; //PA11、PA12
	GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  //推挽输出
	GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
	GPIO_Initure.Speed=GPIO_SPEED_FREQ_HIGH;    	//高速
	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_SET);//PA11,PA12 输出高	
